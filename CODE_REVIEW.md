...
- [PHẦN A: ESP32 FIRMWARE](#phần-a-esp32-firmware)
  - [F-01: Race condition double buffer (CRITICAL)](#f-01-race-condition-double-buffer-trong-hud_streamc)
  - [F-02: Dangling WebSocket request pointer (CRITICAL)](#f-02-dangling-websocket-request-pointer-trong-http_serverc)
  - [F-03: LVGL thread-safety với SPI bus (MEDIUM)](#f-03-lvgl-thread-safety-với-spi-bus)
  - [F-04: display_fill_rect vẽ từng dòng chậm (MEDIUM)](#f-04-display_fill_rect-vẽ-từng-dòng-rất-chậm)
  - [F-05: UDP discovery socket tạo/đóng liên tục (MEDIUM)](#f-05-udp-discovery-socket-tạođóng-liên-tục)
  - [F-06: Hardcoded SoftAP password (MEDIUM)](#f-06-hardcoded-softap-password)
  - [F-07: WebSocket handler thiếu JSON parse error log (MEDIUM)](#f-07-websocket-handler-thiếu-json-parse-error-log)
  - [F-08: Duplicate include cJSON.h (LOW)](#f-08-duplicate-include-cjsonh)
  - [F-09: Thiếu display_draw_bitmap declaration (LOW)](#f-09-thiếu-display_draw_bitmap-declaration-trong-header)
  - [F-10: Boot step numbering không nhất quán (LOW)](#f-10-boot-step-numbering-không-nhất-quán)
- [PHẦN B: ANDROID APP](#phần-b-android-app)
  - [A-01: Static ViewModel reference gây memory leak (CRITICAL)](#a-01-static-viewmodel-reference-gây-memory-leak)
  - [A-02: CoroutineScope không có SupervisorJob (CRITICAL)](#a-02-coroutinescope-không-có-supervisorjob)
  - [A-03: WebSocketManager scope không bao giờ cancel (CRITICAL)](#a-03-websocketmanager-scope-không-bao-giờ-cancel)
  - [A-04: Bitmap allocation mỗi frame trong ScreenCaptureService (MEDIUM)](#a-04-bitmap-allocation-mỗi-frame-trong-screencaptureservice)
  - [A-05: Chỉ buffer 1 pending notification (MEDIUM)](#a-05-chỉ-buffer-1-pending-notification)
  - [A-06: Weather API hardcode tọa độ Hà Nội (MEDIUM)](#a-06-weather-api-hardcode-tọa-độ-hà-nội)
  - [A-07: OkHttpClient tạo mới mỗi lần gọi weather (MEDIUM)](#a-07-okhttpclient-tạo-mới-mỗi-lần-gọi-weather)
  - [A-08: ByteArrayOutputStream tạo mới mỗi frame (MEDIUM)](#a-08-bytearrayoutputstream-tạo-mới-mỗi-frame-trong-mapnavstreamservice)
  - [A-09: UDP discovery port conflict (MEDIUM)](#a-09-udp-discovery-port-conflict)
  - [A-10: sendJson callback chạy trên IO thread (LOW)](#a-10-sendjson-callback-chạy-trên-io-thread)
  - [A-11: Deprecated PreferenceManager API (LOW)](#a-11-deprecated-preferencemanager-api)
