...
static const vn_map_t vn_nfc_table[192] = {
    ...
    {0x00C0, 0x0302, 0x1EA6},
    {0x00C0, 0x0306, 0x1EB0},
    {0x00C1, 0x0302, 0x1EA4},
    {0x00C1, 0x0306, 0x1EAE},
    {0x00C2, 0x0300, 0x1EA6},
    {0x00C2, 0x0301, 0x1EA4},
    {0x00C2, 0x0303, 0x1EAA},
    {0x00C2, 0x0309, 0x1EA8},
    {0x00C2, 0x0323, 0x1EAC},
    {0x00C3, 0x0302, 0x1EAA},
    {0x00C3, 0x0306, 0x1EB4},
    {0x00C8, 0x0302, 0x1EC0},
    {0x00C9, 0x0302, 0x1EBE},
    {0x00CA, 0x0300, 0x1EC0},
    {0x00CA, 0x0301, 0x1EBE},
    {0x00CA, 0x0303, 0x1EC4},
    {0x00CA, 0x0309, 0x1EC2},
    {0x00CA, 0x0323, 0x1EC6},
    {0x00D2, 0x0302, 0x1ED2},
    {0x00D2, 0x031B, 0x1EDC},
    {0x00D3, 0x0302, 0x1ED0},
    {0x00D3, 0x031B, 0x1EDA},
    {0x00D4, 0x0300, 0x1ED2},
    {0x00D4, 0x0301, 0x1ED0},
    {0x00D4, 0x0303, 0x1ED6},
    {0x00D4, 0x0309, 0x1ED4},
    {0x00D4, 0x0323, 0x1ED8},
    {0x00D5, 0x0302, 0x1ED6},
    {0x00D5, 0x031B, 0x1EE0},
    {0x00D9, 0x031B, 0x1EEA},
    {0x00DA, 0x031B, 0x1EE8},
    {0x00E0, 0x0302, 0x1EA7},
    {0x00E0, 0x0306, 0x1EB1},
    {0x00E1, 0x0302, 0x1EA5},
    {0x00E1, 0x0306, 0x1EAF},
    {0x00E2, 0x0300, 0x1EA7},
    {0x00E2, 0x0301, 0x1EA5},
    {0x00E2, 0x0303, 0x1EAB},
    {0x00E2, 0x0309, 0x1EA9},
    {0x00E2, 0x0323, 0x1EAD},
    {0x00E3, 0x0302, 0x1EAB},
    {0x00E3, 0x0306, 0x1EB5},
    {0x00E8, 0x0302, 0x1EC1},
    {0x00E9, 0x0302, 0x1EBF},
    {0x00EA, 0x0300, 0x1EC1},
    {0x00EA, 0x0301, 0x1EBF},
    {0x00EA, 0x0303, 0x1EC5},
    {0x00EA, 0x0309, 0x1EC3},
    {0x00EA, 0x0323, 0x1EC7},
    {0x00F2, 0x0302, 0x1ED3},
    {0x00F2, 0x031B, 0x1EDD},
    {0x00F3, 0x0302, 0x1ED1},
    {0x00F3, 0x031B, 0x1EDB},
    {0x00F4, 0x0300, 0x1ED3},
    {0x00F4, 0x0301, 0x1ED1},
    {0x00F4, 0x0303, 0x1ED7},
    {0x00F4, 0x0309, 0x1ED5},
    {0x00F4, 0x0323, 0x1ED9},
    {0x00F5, 0x0302, 0x1ED7},
    {0x00F5, 0x031B, 0x1EE1},
    {0x00F9, 0x031B, 0x1EEB},
    {0x00FA, 0x031B, 0x1EE9},
    ...
    {0x0168, 0x031B, 0x1EEE},
    {0x0169, 0x031B, 0x1EEF},
    ...
    {0x1EA2, 0x0302, 0x1EA8},
    {0x1EA2, 0x0306, 0x1EB2},
    {0x1EA3, 0x0302, 0x1EA9},
    {0x1EA3, 0x0306, 0x1EB3},
    {0x1EB8, 0x0302, 0x1EC6},
    {0x1EB9, 0x0302, 0x1EC7},
    {0x1EBA, 0x0302, 0x1EC2},
    {0x1EBB, 0x0302, 0x1EC3},
    {0x1EBC, 0x0302, 0x1EC4},
    {0x1EBD, 0x0302, 0x1EC5},
    {0x1ECC, 0x0302, 0x1ED8},
    {0x1ECC, 0x031B, 0x1EE2},
    {0x1ECD, 0x0302, 0x1ED9},
    {0x1ECD, 0x031B, 0x1EE3},
    {0x1ECE, 0x0302, 0x1ED4},
    {0x1ECE, 0x031B, 0x1EDE},
    {0x1ECF, 0x0302, 0x1ED5},
    {0x1ECF, 0x031B, 0x1EDF},
    {0x1EE4, 0x031B, 0x1EF0},
    {0x1EE5, 0x031B, 0x1EF1},
    {0x1EE6, 0x031B, 0x1EEC},
    {0x1EE7, 0x031B, 0x1EED},
};